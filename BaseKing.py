...
def main():
	formatter = "{:04x}".format #Print as hex.

	key = [random.randint(0, MASK) for i in range(12)] #Generate random 192-bits key split in parts of 16 bits.
	block = [random.randint(0, MASK) for i in range(12)] # Generate random 192-bits plaintext split in parts of 16 bits.
